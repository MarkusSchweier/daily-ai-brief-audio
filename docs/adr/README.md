...
| [0008](0008-skill-content-change-lockstep-and-live-version-push.md) | Skill-content lockstep (reconciled to two-way by ADR-0014) + live Skills-API version push | Accepted (amended 2026-07-06) |
...
| [0016](0016-eval-harness-reintegration.md) | Eval-harness re-integration: a local-first, git-native harness driving the decoupled candidate mechanism (cost-optimization epic, step A) | Proposed — Gate 0, awaiting owner sign-off (D5/UI + open items pending); supersedes ADR-0013 |
