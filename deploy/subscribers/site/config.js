// API base URL for the subscribe form's fetch target.
//
// This is intentionally a small, easy-to-edit constant rather than baked into index.html:
// before the briefing.mschweier.com custom domain / DNS is wired up, this should point at
// the temporary API Gateway `execute-api` URL from the `HttpApiUrl` CDK stack output
